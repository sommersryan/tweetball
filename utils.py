...
def getCity():
	citiesEndpoint = "https://randomuser.me/api/?inc=location,nat"
...
'Bears','Hornets','Patriots','Hawks','Rebels',
'Bobcats','Saints','Blue Devils','Titans','Wolverines',
...
'Cavaliers','Generals','Owls','Buccaneers',
...
'Tornadoes','Blues','Cobras','Bulls','Express','Stallions', 'Addicks',
'Ash Trees','Atom Men','Avenue','Badgers','Baggies','Bantams','Beavers',
'Bees','Biscuitmen','Black Cats','Blades','Bluebirds','Blues','Boro',
'Brewers','Bucks','Bury','Canaries','Castle','Cardinals','Carpetmen',
'Chairboys','Cherries','Citizens','Clarets','Cobblers','Cod Army',
'Cottagers','Cumbrians','Daggers','Dale','Diamonds','Dolly Blues',
'Donny','Dons','Eagles','Filberts','Fleet','Fosse','Foxes','Gas',
'Gills','Glassboys','Glaziers','Glovers','Grecians','Greens','Gulls',
'Gunners','Hammers','Harriers','Hatters','Heed','Hoops','Hornets','Imps',
'Ingfielders','Iron','Irons','Knitters','Lambs','Lashers','Latics','Lilywhites',
'Linnets','Lions','Magpies','Mariners','Millers','Minstermen','Mushrooms',
'Nailers','Owls','Peacocks','Pilgrims','Pensioners','Pirates','Pompey',
'Pool','Poppies','Posh','Potters','Puritans','Quakers','Railwaymen',
'Rams','Red Rebels','Red Devils','Red Imps','Reds','Riversiders','Robins',
'Rooks','Royals','Saddlers','Saints','Salop','Sandgrounders','Seagulls',
'Seals','Seasiders','Shakers','Shaymen','Shots','Shrews','Shrimps',
'Shrimpers','Shopmates','Silkmen','Sky Blues','Smoggies','Spireites',
'Spitfires','Sports','Spurs','Spartans','Stags','Stones','Stripes','Swans',
'Super Hoops','Tangerines','Tarn','Terras','Terriers','Teyn','Throstles',
'Tigers','Toffees','Toffeemen','Tractor Boys','Tricky Trees','Trotters',
'Two Blues','Tykes','Tynesiders','Valiants','Vics','Vikings','Villans',
'Wednesday','Whites','Wolves','Wombles','Yellows','Yeltz', 'Green and Whites',
'Blood and Gold','Buffalos','Dragons','Green Eagles','Pirates','Chamois',
'Wild Boars','Blacksmiths','Hakes','Graoully Dragons','Maroons','Lion Cubs',
'Blue and White','Mastiffs','Crocodiles','Eaglets','Boys','Phocians',
'Parisians','Lions','Purples','Athenians','Red Devils','Potato Beetles',
'Factory IX','Black and Yellows','Foals','Eagles','Fortress Guards','Billy Goats',
'Miners','Royal Blues','Dinosaurs','Zebras','Clover Leaves','Union','Legend',
'Greens','Goddess','Roosters','Lioness','Islanders','Elephants','Seahorses',
'Flying Donkeys','Purples','Griffin','Little Donkeys','Eagles','Dolphins','Little Zebras',
'Romanticists','Super Peasants','Kralingers','Sheep Heads','Black Sheep','Heraclids',
'Peasants','Super Frisians','Chatelains','Lads','Stripes','Railwaymen','Armymen','White Star','Archbishops','Arsenalists','Violet Eagles','Spartans',
'Sharks','Miners','Gasers','Yellow Wolves','Bankers','Knights of Sycamore Leaf',
'Barbers','Crazy Gang','Speeders','Steeds','Dynamic','Rats','Pigs','Bums','Yugoslavs',
'Hedonists','Mattress Makers','Harlequins','Little Celts','Bottoms','Arsers','Frogs',
'Anchovies','Budgies','Whites','Galactics','Meringues','Vikings','Royal','Oaks',
'Mackerels','Angels','Comrades','Blue Lightning','Scorpions','Storm','Miners','Moles']
