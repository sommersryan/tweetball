	...
	def __init__(self, game):
		...
		for batter in game.awayTeam.lineup.battingOrder:
			...
			if batter.battingGameStats['PA'] > 0:
				batter.battingGameStats['OBP'] = RateStat(1 - (
							(batter.battingGameStats['strikeout'] + batter.battingGameStats['inPlayOut']) /
							batter.battingGameStats['PA']))
		...
		for pitcher in game.awayTeam.lineup.usedPitchers:
			...
			if pitcher.pitchingGameStats['BF'] > 0:
				...
				if pitcher.pitchingGameStats['IP'] == 0:
					...
					pitcher.pitchingGameStats['RA'] = (pitcher.pitchingGameStats['R'] / float(
						pitcher.pitchingGameStats['IP'])) * 9
